...
OUTPUT_REPO = "P2SAMAPA/p2-etf-donaldson-thomas-results"
...
# DT parameters
N_PARTITIONS = 10            # number of partitions for moduli space
STABILITY_THRESHOLD = 0.5    # threshold for stable configurations
TOP_N = 3
